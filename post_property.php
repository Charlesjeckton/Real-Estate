   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="number" name="price" required min="0" max="999999999999" maxlength="20" placeholder="Enter property price" class="input">
         </div>
         <div class="box">
            <p>Deposit amount <span>*</span></p>
            
            <input type="number" name="deposite" required min="0" max="999999999999" maxlength="20" placeholder="Enter deposit amount" class="input">
