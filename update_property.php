   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="text" id="priceInput" onkeyup="formatMoneyInput('priceInput')" name="price" required min="0" max="9999999999" maxlength="10" value="<?= $fetch_property['price']; ?>" placeholder="Enter property price" class="input">
         </div>
         <div class="box">
            <p>Deposit amount <span>*</span></p>
            <input type="text" id="depositInput" onkeyup="formatMoneyInput('depositInput')" name="deposite" required min="0" max="9999999999" value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="Enter deposit amount" class="input">
         </div>
         <div class="box">
