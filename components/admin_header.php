<header class="header">
   ...
   <a href="../components/admin_logout.php" onclick="return confirm('Do you want to logout from this website?');" class="delete-btn"><i class="fas fa-right-from-bracket"></i><span>logout</span></a>
