...
<section class="requests">
   ...
   <h1 class="heading">all received requests</h1>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete request" class="btn" onclick="return confirm('Do you want remove this request?');" name="delete">
